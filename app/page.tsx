  ...
  return (
    <main className="min-h-screen bg-black">
      ...
      <SectionWrapper id="contact">
        <div className="max-w-[1400px] mx-auto px-6">
          {/* Section Header */}
          <SectionHeader title="Get in Touch" subtitle="Ready to elevate your UX with AI? Let's start a conversation about your project." />

          {/* Contact Grid */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {/* Contact Information */}
            <div className="p-8 rounded-2xl bg-zinc-900/30 border border-zinc-800/50">
              <h3 className="text-2xl font-bold text-zinc-100 mb-8">Contact Information</h3>
              <div className="space-y-6">
                <div className="flex items-center gap-4">
                  <div className="bg-zinc-800 w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0">
                    <MapPin className="h-5 w-5 text-zinc-100" />
                  </div>
                  <p className="text-zinc-400">123 AI Boulevard, Tech City, TC 12345</p>
                </div>
                <div className="flex items-center gap-4">
                  <div className="bg-zinc-800 w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0">
                    <Phone className="h-5 w-5 text-zinc-100" />
                  </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-zinc-400">hello@happyux.ai</p>
                </div>
                <div className="flex items-center gap-4">
                  <div className="bg-zinc-800 w-10 h-10 rounded-full flex items-center justify-center flex-shrink-0">
                    <MessageSquare className="h-5 w-5 text-zinc-100" />
                  </div>
                  <p className="text-zinc-400">Live chat available 24/7</p>
                </div>
              </div>
            </div>
            ...
            {/* Contact Form */}
            <div className="p-8 rounded-2xl bg-zinc-900/30 border border-zinc-800/50">
              <h3 className="text-2xl font-bold text-zinc-100 mb-8">Send us a Message</h3>
                    ...
                    {projectTypeOptions.map((type) => (
                      <div key={type} className="flex items-center space-x-2">
                        <Checkbox
                          ...
                          className="border-zinc-700 data-[state=checked]:bg-zinc-100 data-[state=checked]:border-zinc-100"
                        />
